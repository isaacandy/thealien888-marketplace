...
export default function Home() {
  return (
    <main className="relative mx-auto flex min-h-screen max-w-6xl flex-col px-4 py-8 sm:px-6 lg:px-10">
      ...
      {/* 1. NFT Management & Bidding Section */}
      <section id="marketplace" className="relative z-10 mt-10">
        <div className="bg-black/90 p-6">
          <div className="mb-6 flex items-center justify-between pb-4">
            <h2 className="text-xl font-bold text-emerald-100 flex items-center gap-2">
               TheAlien.888 Generative NFT Project Status
            </h2>
      ...
      {/* 2. Web3 Subdomain Claim Section */}
      <section id="identity" className="relative z-10 mt-12">
        <SubdomainClaim />
      </section>

      {/* 3. Hibernation & Staking Section */}
